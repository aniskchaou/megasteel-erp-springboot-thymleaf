...
public class OrderStatusController {
	...
	public String updateOrderStatus(@PathVariable("id") long id, @Validated OrderState orderStatus, BindingResult result,
			Model model) {
	...
	@Transactional
	public String deleteOrderStatus(@PathVariable("id") int id) {
